...
public class IEsperto {
    Scanner sc;
    GestoreProgetto gestoreProgetto  = new GestoreProgetto();
    GestoreValutazioni gestoreValutazioni  = new GestoreValutazioni();
    ...
    public void valutaProposta() {
        ...
        if(input.equals("Y")){
            this.visualizzaListaProgetti(StatoProgetto.IN_VALUTAZIONE_PROGETTO);
    ...
    public void valutaProgettisti() {
        ...
        String input = sc.nextLine().toUpperCase();
        if(input.equals("Y")){
            this.visualizzaListaProgetti(StatoProgetto.IN_VALUTAZIONE_CANDIDATURE);
            ...
            if (!idProgetto.equals("EXIT")) {
                ...
                this.visualizzaCandidature(idProgetto); // aggiunto
                ...
                while (true) {
                    ...
                    this.visualizzaInfoProgettista(idInput);
    ...
    //public void selezionaProposta(String idProgetto) {
    ...
    public void visualizzaInfoProgettista(String idProgettista) { // info progettista da candidatura
        System.out.println(gestoreProgettisti.getInfoProgettista(idProgettista));
    }


    public void visualizzaListaProgetti(StatoProgetto statoProgetto) {
        Set<Progetto> progettiTrovati = gestoreProgetto.getListaProgetti(statoProgetto);
        if (progettiTrovati.size()==0) {
            System.out.println("Non ci sono progetti per cui effettuare una valutazione");
            return;
        }
